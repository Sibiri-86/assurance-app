...
export class HistoriqueAvenantAdherantEffects {
 ...
 /*   createHistoriqueAvenant$ = createEffect(() =>
    ...
    this.actions$.pipe(
        ...
        fetchHistoriqueAvenantByAdherentPrincipal$ = createEffect(() =>
    this.actions$.pipe(
            ofType(featureActions.loadHistoriqueAvenantAdherentByAdherentPrincipal),
            mergeMap(({adherentId}) =>
                this.historiqueAvenantAdherantService.findFamilleByAdherentPrincipal(adherentId).pipe(
                    switchMap(value => [
                        featureActions.setHistoriqueAvenantAdherent(value)
                    ]),
                    catchError(error => of(GlobalConfig.setStatus(StatusEnum.error, null, error)))
    ...
    this.actions$.pipe(
        ...
        fetchHistoriqueAvenantByHistoriqueId$ = createEffect(() =>
        this.actions$.pipe(
                ofType(featureActions.loadHistoriqueAvenantAdherentByHistoriqueId),
                mergeMap(({haId}) => this.historiqueAvenantAdherantService
                        .getHistoriqueAvenantAdherentsByHistoriqueId(haId).pipe(
                        switchMap(value => [
                            featureActions.setHistoriqueAvenantAdherent(value)
                        ]),
                        catchError(error => of(GlobalConfig.setStatus(StatusEnum.error, null, error)))
    ...
    this.actions$.pipe(
        ...
        fetchHistoriqueAvenantAdherentByPoliceAndExercice$ = createEffect(() =>
    this.actions$.pipe(
            ofType(featureActions.loadHistoriqueAvenantAdherentByPoliceAndExercice),
            mergeMap(({idPolice, exerciceId}) => this.historiqueAvenantAdherantService
                .findHistoriqueAvenantAdherantActuallByExercice(idPolice, exerciceId).pipe(
                    switchMap(value => [
                        featureActions.setHistoriqueAvenantAdherent(value)
                    ]),
                    catchError(error => of(GlobalConfig.setStatus(StatusEnum.error, null, error)))
