export enum TypeReport {
    ...
    EVOLUTION_MESUELLE = 'EVOLUTION_MESUELLE',
    ...
    NOMBRE_CHEQUE_VALIDE ='NOMBRE_CHEQUE_VALIDE',
    FACTURE_PRESTATAIRE = "FACTURE_PRESTATAIRE",
    NOMBRE_CHEQUE_NON_VALIDE= 'NOMBRE_CHEQUE_NON_VALIDE',
    CONSOMMATION_PAR_FAMILLE_ASSURE = 'CONSOMMATION_PAR_FAMILLE_ASSURE',
    BILAN = 'BILAN',
    COMPTE_RESULTAT ='COMPTE_RESULTAT',
    COURRIER_PRESTATAIRE ='COURRIER_PRESTATAIRE'
}
