...
export const setOperationLeutree = createAction('[App Init] set Operation leutree',  props<OperationLeutreeList>());
...
export const loadOperationByExerciceOperationLeutree = createAction('[App Init] load Operation leutree By Exercice', props<{exerciceOperationId: string}>());
