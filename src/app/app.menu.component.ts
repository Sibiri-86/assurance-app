        ...
        this.model = [
            ...
            },
            {
                ...
                },
                {
                    ...
                    {label: 'Statistique des chèques non valide', routerLink: ['/reporting/reporting-cheque-non-valide'], visible: true},
                    {label: 'Statistique des chèques valide par prestataire', routerLink: ['/reporting/reporting-cheque-valide'], visible: true},
