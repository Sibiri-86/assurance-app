...
@Component({
  selector: 'app-grand-livre-auxiliaire',
  templateUrl: './grand-livre-auxiliaire.component.html',
  styleUrls: ['./grand-livre-auxiliaire.component.scss']
})
export class GrandLivreAuxiliaireComponent implements OnInit, OnDestroy {
  ...
  compteList$: Observable<Array<Tiers>>;
  compteList: Array<Tiers>;
  ...
  constructor( private store: Store<AppState>,
               ...
               private formBuilder: FormBuilder,  private messageService: MessageService,  private breadcrumbService: BreadcrumbService) {
                this.breadcrumbService.setItems([{ label: 'Grand livre auxiliaire'}]);
   }
  ...
  ngOnInit(): void {
    ...
    this.compteList$ = this.store.pipe(select(tierSelector.tiersList));
  ...
  imprimer() {
    ...
    this.report.typeReporting = TypeReport.GRAND_LIVRE_AUXILIAIRE;
  ...
  findOperationGrandLivre() {
    ...
    this.store.dispatch(featureActionOperation.findOperationGrandLivreAuxiliaire(this.operation));
  }
