...
@Component({
  selector: 'app-depense-optique',
  templateUrl: './depense-optique.component.html',
  styleUrls: ['./depense-optique.component.scss']
})
export class DepenseOptiqueComponent implements OnInit, OnDestroy {
