...
@Component({
  selector: 'app-evolution-mensuelle',
  templateUrl: './evolution-mensuelle.component.html',
  styleUrls: ['./evolution-mensuelle.component.scss']
})
export class EvolutionMensuelleComponent implements OnInit, OnDestroy {
  ...
  findOperationGrandLivre() {
    ...
    this.report.typeReporting = TypeReport.EVOLUTION_MESUELLE;
