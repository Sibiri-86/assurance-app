...
@Component({
  selector: 'app-famille-assure',
  templateUrl: './famille-assure.component.html',
  styleUrls: ['./famille-assure.component.scss']
})
export class FamilleAssureComponent implements OnInit, OnDestroy {
  ...
  consommationFamilleForm: FormGroup;
  cosommationFamille: ConsommationParFamille;
  ...
  constructor( private store: Store<AppState>,
    ...
    this.consommationFamilleForm = this.formBuilder.group({
      dateDebut: new FormControl('', [Validators.required]),
      dateFin: new FormControl('', [Validators.required]),
      garantId: new FormControl('', [Validators.required]),
  ...
  this.store.dispatch(statistiqueParTrancheAgeAction.setReportConsommationParFamille(null));
  ...
  loadPoliceByGarant() {
       this.store.dispatch(featureActionPolice.getPoliceByGarant({garantId: this.consommationFamilleForm.get('garantId').value.id}));
  ...
  loadGroupeByPolice(){
    this.store.dispatch(groupefeatureAction.loadGroupe({policeId: this.consommationFamilleForm.get('policeId').value.id}));
  }
  ...
  imprimerConsommationParFamille() {
    //console.log('recap=============>', recap);
    this.cosommationFamille = {};
    this.cosommationFamille.garantId = this.consommationFamilleForm.get('garantId').value?.id;
    this.cosommationFamille.policeId = this.consommationFamilleForm.get('policeId').value?.id;
    this.cosommationFamille.dateDebut = this.consommationFamilleForm.get('dateDebut').value;
    this.cosommationFamille.groupeId = this.consommationFamilleForm.get('groupeId').value?.id;
    this.cosommationFamille.dateFin = this.consommationFamilleForm.get('dateFin').value;
    this.report.typeReporting = TypeReport.CONSOMMATION_PAR_FAMILLE_ASSURE;
    this.report.consommationParFamille = this.cosommationFamille;
    console.log('this.cosommationFamille=============>', this.cosommationFamille);
