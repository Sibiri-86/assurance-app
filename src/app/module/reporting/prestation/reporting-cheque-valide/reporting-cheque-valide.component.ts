...
@Component({
  selector: 'app-reporting-cheque-valide',
  templateUrl: './reporting-cheque-valide.component.html',
  styleUrls: ['./reporting-cheque-valide.component.scss']
})
export class ReportingChequeValideComponent implements OnInit, OnDestroy {
