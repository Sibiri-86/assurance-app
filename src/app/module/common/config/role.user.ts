...
export const UsersRoles = {
    ...
    Function.sm_export_depense_excel, Function.sm_medical_pretataire, Function.sm_medical_tout, Function.sm_devalider_ordre, Function.sm_finance_voir_detail_ordre, Function.sm_finance_payer_ordreTiersPayant]
};
