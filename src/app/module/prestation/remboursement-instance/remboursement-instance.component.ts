...
@Component({
  selector: 'app-remboursement-instance',
  templateUrl: './remboursement-instance.component.html',
  styleUrls: ['./remboursement-instance.component.scss']
})
export class RemboursementInstanceComponent implements OnInit, OnDestroy {
  ...
  constructor( private store: Store<AppState>,
               ...
               private router: Router) {
                this.breadcrumbService.setItems([{ label: 'Remboursements en instance' }]);
   }
...
findMontantPlafond(event){
  ...
  ngOnInit(): void {
    ...
    this.store.dispatch(featureActionRemboursement.loadRemboursementPrestation());
  ...
  valider(remboursement: Remboursement) {
    remboursement.validePrestation = true;
    this.store.dispatch(featureActionRemboursement.ValiderRemboursementPrestation(remboursement));
  }
