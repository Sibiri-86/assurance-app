...
import * as loadAdherent from '../../../../store/contrat/adherent/actions';
import {
    AvenantModification,
    HistoriqueAvenant,
...
import * as familleActeSelector from '../../../../store/parametrage/garantie/selector';
import * as fectureFamilleActeAction from '../../../../store/parametrage/garantie/actions';
import * as typeGarantSelector from '../../../../store/parametrage/garant/selector';
import * as typeGarantAction from '../../../../store/parametrage/garant/actions';
...
export class AvenantRenouvellementComponent implements OnInit {
    ...
    adherantListTMP: Array<Adherent>;
    ...
    groupePolicy: any;
    obj: any = {group: {}, prime: {}};
    private historiqueAveantAdherants: HistoriqueAvenantAdherant[];
    ...
    loadAdherantByPolice(): void {
        this.adherentService.getAdherentsByPolice(this.police.id).subscribe(
            (res) => {
                ...
                this.addHistoriqueAvenantAdherant(this.adherantListTMP);
            }
        );
    }
