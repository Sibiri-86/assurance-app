...
@Component({
  selector: 'app-renouvellement-adherent-list',
  templateUrl: './renouvellement-adherent-list.component.html',
  styleUrls: ['./renouvellement-adherent-list.component.scss']
})
export class RenouvellementAdherentListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log('this.historiqueAvenantAdherantTMPs ==== ' + this.historiqueAvenantAdherantTMPs);
